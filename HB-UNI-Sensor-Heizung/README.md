...
- Der Status (An/Aus) wird dabei in HomeMatic auf den HB-UNI-Sensor1 Datenpunkt 'Digitaler Eingang / Ventilposition' gelegt (um das vorhandene AddOn nutzen zu können).
